...
export class UpdateClassRequest {
  ...
  static fromJson(json: any): UpdateClassRequest {
    ...
    Object.assign(dto, {
      ...
      startAt: json.startAt ? DateTimeUtils.formatStringToDateTime(json.startAt) : undefined,
      endAt: json.endAt ? DateTimeUtils.formatStringToDateTime(json.endAt) : undefined,
