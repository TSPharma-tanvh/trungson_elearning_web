export const paths = {
  ...
  dashboard: {
    ...
    lesson: '/dashboard/lesson/lesson',
    lessonCourse: '/dashboard/courses/lesson',
    userPathProgress: '/dashboard/progress/path',
    userCourseProgress: '/dashboard/courses/progress',
    userCourseProgressCreate: '/dashboard/courses/enroll',
    userLessonProgress: '/dashboard/lesson/progress',
    userLessonProgressCreate: '/dashboard/lesson/enroll',
