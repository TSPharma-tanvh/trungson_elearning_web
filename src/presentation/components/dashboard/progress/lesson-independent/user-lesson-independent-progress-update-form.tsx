...
interface EditUserLessonProgressIndependentDialogProps {
  open: boolean;
...
export function UpdateUserLessonProgressIndependentFormDialog({
  open,
  data: userLessonProgress,
  onClose,
  onSubmit,
}: EditUserLessonProgressIndependentDialogProps) {
