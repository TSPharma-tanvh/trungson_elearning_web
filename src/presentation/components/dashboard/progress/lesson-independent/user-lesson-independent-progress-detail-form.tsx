...
interface UserLessonProgressDetailIndependentProps {
  open: boolean;
  userLessonProgressId: string | null;
  onClose: () => void;
}

function UserLessonProgressDetailsIndependent({
  userLessonProgress,
  fullScreen,
}: {
...
export default function UserLessonProgressDetailForm({
  ...
  onClose,
}: UserLessonProgressDetailIndependentProps) {
  const { t } = useTranslation();
    ...
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="lg" fullScreen={fullScreen}>
      ...
      <DialogContent dividers sx={{ p: 0 }}>
        {loading || !userLessonProgress ? (
          ...
          <UserLessonProgressDetailsIndependent userLessonProgress={userLessonProgress} fullScreen={fullScreen} />
        )}
      </DialogContent>
    </Dialog>
  );
