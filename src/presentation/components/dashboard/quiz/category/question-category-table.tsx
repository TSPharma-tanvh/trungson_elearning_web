...
import QuestionCategoryDetailForm from './question-category-detail-form';
import { QuestionUpdateCategoryFormDialog } from './question-category-update-form';
...
export default function QuestionCategoryTable({
  ...
  return (
    <>
      ...
      {editCategoryData ? (
        <QuestionUpdateCategoryFormDialog
          open={editOpen}
