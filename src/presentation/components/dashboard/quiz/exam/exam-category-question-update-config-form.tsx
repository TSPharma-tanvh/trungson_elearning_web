...
interface ExamCategoryConfigUpdateFormProps {
  value: QuizCategoryConfigUpdate[];
  onChange: (value: QuizCategoryConfigUpdate[]) => void;
  categoryUsecase: CategoryUsecase | null;
}

export function ExamCategoryConfigUpdateForm({ value, onChange, categoryUsecase }: ExamCategoryConfigUpdateFormProps) {
