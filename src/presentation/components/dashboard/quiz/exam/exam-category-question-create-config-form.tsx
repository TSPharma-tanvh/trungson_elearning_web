...
interface ExamCategoryConfigCreateFormProps {
  value: QuizCategoryConfigCreate[];
  onChange: (value: QuizCategoryConfigCreate[]) => void;
  categoryUsecase: CategoryUsecase | null;
}

export function ExamCategoryConfigCreateForm({ value, onChange, categoryUsecase }: ExamCategoryConfigCreateFormProps) {
