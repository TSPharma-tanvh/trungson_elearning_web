...
interface IndependentLessonSingleSelectDialogProps extends Omit<SelectProps<string>, 'value' | 'onChange'> {
...
export function IndependentLessonSingleSelectDialog({
  lessonUsecase,
  value,
  onChange,
  label = 'lessons',
  disabled = false,
  ...selectProps
}: IndependentLessonSingleSelectDialogProps) {
