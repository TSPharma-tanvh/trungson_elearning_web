...
interface QuizSingleSelectExamProps extends Omit<SelectProps<string>, 'value' | 'onChange'> {
...
export function QuizSingleSelectExam({
  quizUsecase,
  value,
  onChange,
  label = 'exam',
  ...
  const [quizType, setQuizType] = useState<QuizTypeEnum | undefined>(QuizTypeEnum.ExamQuiz);
