...
interface UseCategoryQuestionLoaderProps {
...
interface CategoryQuestionLoaderState {
...
export function useCategoryQuestionLoader({
  categoryUsecase,
  isOpen,
  categoryEnum,
  searchText: initialSearchText = '',
}: UseCategoryQuestionLoaderProps): CategoryQuestionLoaderState {
  ...
  const loadCategories = async (page: number, reset = false) => {
    ...
    try {
      ...
      const result: CategoryListResult = await categoryUsecase.getCategoryQuestionList(request);
